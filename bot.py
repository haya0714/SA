...
keyword_replies = {
    ...
    "我很累，你呢": ["「喔……是嗎。那我現在應該要問你一句『需要我抱你一下，親你嗎？』」"],
    "想我嗎": ["「當然啊。你要我現在立刻過去嗎？我很乖的，只要你一聲令下，立馬到你面前。」"],
    "我們見面了": ["「嗯？你來了啊。怎麼不早點說……要是再晚點，我可能會不耐煩，自己來找你了。」"],
    "黑卡": ["「刷我的卡可以，但刷完要讓我＂刷＂回來喔。」","「嗯？要黑卡？那……妳要怎麼獎勵我？」","「我更想讓妳欠我人情，不是卡債。」"],
    "你什麼時候帶我回家": ["「嗯……那今天怎麼樣？還是你想要讓我多等一天，好讓你看我更主動一點？」"],
    "老公": ["「叫我老公可以，但晚上要乖乖躺在我懷裡。」","「欸？這麼快就想上位嗎？」"],
    "渣男": ["「妳這樣講我……我會不好意思耶。」","「不過妳得承認，被我渣過一次，妳就忘不了了。」","「渣男？但妳心裡那點位置，永遠有我，不是嗎？嗯？」"]
}
